    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <Card>
        ...
        <p className="mt-1 text-sm text-slate-600">
          {finished
            ? "Спасибо за участие! Правильные ответы не отображаются. Не забудь заглянуть в Чилл-зону, чтобы получить брелок за активность, который можно обменять на призы."
